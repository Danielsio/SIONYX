...
const LandingPage = () => {
  ...
  const handleOrganizationRegister = useCallback(
    async values => {
      setLoading(true);
      try {
  ...
  const handleOrganizationValidate = useCallback(
    async values => {
      setLoading(true);
      try {
    ...
    <div style={{ direction: 'rtl' }}>
      ...
      >
        <Form.Item
          ...
          label={
            <Text style={{ fontWeight: 700, color: '#1a1a1a', fontSize: '16px' }}>שם הארגון</Text>
          }
          rules={[
        ...
        <Form.Item
          name='nedarimMosadId'
          label={
            <Text style={{ fontWeight: 700, color: '#1a1a1a', fontSize: '16px' }}>
              מזהה מוסד נדרים
            </Text>
          }
          rules={[{ required: true, message: 'אנא הזן את מזהה המוסד' }]}
        >
          <Input
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'אנא הזן את מפתח ה-API' }]}
        >
          <Input
        ...
        <Form.Item style={{ marginBottom: 0, textAlign: 'center' }}>
          ...
          >
            {loading ? (
              ...
              <>
                <UserAddOutlined /> הרשם ארגון חדש
              </>
            )}
          </Button>
        </Form.Item>
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          {downloadLoading ? (
            ...
            <>
              <DownloadOutlined /> הורד תוכנה עכשיו
            </>
          )}
        </Button>
      </div>
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <Space direction='vertical' size='large' style={{ width: '100%' }}>
                          ...
                          >
                            ...
                            <Text style={{ fontSize: '16px', color: '#374151', fontWeight: 600 }}>
                              ניהול זמן מחשבים מתקדם
                            </Text>
                          </div>
                          <div
                            style={{
                      ...
                      >
                        ...
                        <Row gutter={[20, 20]} style={{ marginBottom: '40px' }}>
                          <Col span={12}>
                            ...
                            >
                              <SecurityScanOutlined
                                style={{ fontSize: '28px', color: '#667eea', marginBottom: '12px' }}
                              />
                              <Text
                                style={{
                                  display: 'block',
                        ...
                        >
                          ...
                          <div style={{ position: 'relative', zIndex: 2 }}>
                            <CrownOutlined
                              style={{ fontSize: '32px', color: 'white', marginBottom: '16px' }}
                            />
                            <Text
                              style={{
                                color: 'white',
