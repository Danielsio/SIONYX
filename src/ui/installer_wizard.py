...
class InstallerWizard(QWizard):
    ...
    def __init__(self, parent=None):
        ...
        # Connect signals
        self.button(QWizard.WizardButton.FinishButton).clicked.connect(self.finish_setup)
...
class OrganizationPage(QWizardPage):
    ...
    def validatePage(self):
        ...
        if not org_id or not org_name:
            QMessageBox.warning(self, "Validation Error", "Please fill in both Organization ID and Name")
            return False
        
        import re
        if not re.match(r'^[a-z0-9-]+$', org_id):
            QMessageBox.warning(self, "Invalid Organization ID", 
...
class PaymentPage(QWizardPage):
    ...
    def __init__(self):
        ...
        self.callback_url_edit.setPlaceholderText("https://us-central1-sionyx-19636.cloudfunctions.net/nedarimCallback")
    ...
    def toggle_payment_fields(self, enabled):
        ...
        if enabled:
            ...
            self.callback_url_edit.setText("https://us-central1-sionyx-19636.cloudfunctions.net/nedarimCallback")
...
class SummaryPage(QWizardPage):
    ...
    def __init__(self):
        ...
        warning_label.setStyleSheet("background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 4px; padding: 10px;")
