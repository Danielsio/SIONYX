...
class Gradients:
    ...
    PRIMARY_GRADIENT = "qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #3B82F6, stop:1 #1E40AF)"
    SUCCESS_GRADIENT = "qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #10B981, stop:1 #059669)"
    WARNING_GRADIENT = "qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #F59E0B, stop:1 #D97706)"
    ERROR_GRADIENT = "qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #EF4444, stop:1 #DC2626)"
    CARD_GRADIENT = "qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #FFFFFF, stop:1 #F8FAFC)"
    SIDEBAR_GRADIENT = "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #1E293B, stop:1 #0F172A)"
...
def get_shadow_effect(blur_radius: int = Shadows.MEDIUM_BLUR, 
                     y_offset: int = Shadows.Y_OFFSET_MEDIUM,
                     color: str = Shadows.MEDIUM) -> Dict[str, Any]:
...
def get_button_style(button_type: str = "primary", 
                    size: str = "medium") -> str:
...
def get_card_style(card_type: str = "default") -> str:
    ...
    if card_type == "default":
        ...
        return f"""
            ...
            QFrame:hover {{
                /* No hover effects for stat cards */
            }}
        """
