...
from ui.constants.ui_constants import (
    ...
    Typography, Shadows, get_shadow_effect, get_button_style, get_card_style
)
...
class BaseCard(QFrame):
    ...
    def setup_base_style(self):
        ...
        self.setStyleSheet(get_card_style(self.card_type))
...
class StatCard(BaseCard):
    ...
    def __init__(self, title: str, value: str, subtitle: str = "", 
                 color: str = Colors.PRIMARY, icon: str = "", parent=None):
    ...
    def setup_layout(self):
        """Setup card layout"""
        # Use natural sizing - let content determine the size
        self.setMinimumSize(200, 120)  # Reasonable minimum
        self.setMaximumSize(500, 300)  # Generous maximum
        ...
        # Apply stronger shadow for stat cards
        self.setup_strong_shadow()
    ...
    def create_icon_title_row(self) -> QWidget:
        ...
        row_layout.setSpacing(Spacing.ELEMENT_SPACING)
        
        # Icon - use default sizing
        icon_label = QLabel(self.icon)
        icon_label.setFont(QFont(Typography.FONT_FAMILY, Typography.SIZE_2XL))
        icon_label.setStyleSheet(f"color: {self.color};")
        
        # Title - use default sizing
        title_label = QLabel(self.title)
        title_label.setFont(QFont(Typography.FONT_FAMILY, Typography.SIZE_MD, 
    ...
    def create_value_label(self) -> QLabel:
        ...
        value_label.setFont(QFont(Typography.FONT_FAMILY, Typography.SIZE_3XL, 
                                 Typography.WEIGHT_EXTRABOLD))
        value_label.setStyleSheet(f"""
            color: {self.color};
            padding: {Spacing.ELEMENT_SPACING}px;
...
class HeaderSection(QFrame):
    ...
    def setup_layout(self):
        ...
        layout = QVBoxLayout(self)
        layout.setContentsMargins(Spacing.SECTION_MARGIN, Spacing.SECTION_MARGIN,
                                 Spacing.SECTION_MARGIN, Spacing.SECTION_MARGIN)
...
class EmptyState(QWidget):
    ...
    def __init__(self, icon: str = "📋", title: str = "אין נתונים", 
    ...
    def setup_content(self):
        ...
        # Title
        title_label = QLabel(self.title)
        title_label.setFont(QFont(Typography.FONT_FAMILY, Typography.SIZE_XL, 
...
class StatusBadge(QLabel):
    ...
    def setup_style(self):
        ...
        text_color, bg_color = self.STATUS_COLORS.get(self.status, 
                                                      (Colors.TEXT_SECONDARY, Colors.GRAY_100))
