...
class ComputerService:
    ...
    def register_computer(self, computer_name: str = None, location: str = None) -> Dict:
        """
        ...
        try:
            ...
            elif not computer_info.get('computerName') or computer_info['computerName'] == 'Unknown-PC':
                computer_info['computerName'] = f"PC-{computer_info['deviceId'][:8].upper()}"
    ...
    def update_computer_activity(self, computer_id: str) -> Dict:
        ...
        try:
            ...
            result = self.firebase.db_update(f'computers/{computer_id}', {
                'lastSeen': now,
                'updatedAt': now,
                'isActive': True
            })
    ...
    def associate_user_with_computer(self, user_id: str, computer_id: str) -> Dict:
        ...
        try:
            ...
            if result.get('success'):
                # Also update computer with current user
                self.firebase.db_update(f'computers/{computer_id}', {
    ...
    def disassociate_user_from_computer(self, user_id: str, computer_id: str) -> Dict:
        ...
        try:
            ...
            user_result = self.firebase.db_update(f'users/{user_id}', {
            ...
            computer_result = self.firebase.db_update(f'computers/{computer_id}', {
                'currentUserId': None,
                'lastUserLogout': now,
                'updatedAt': now
            })
        ...
        try:
            ...
            for computer_id, computer_data in computers.items():
                ...
                if current_user_id:
                    ...
                    stats['user_computer_usage'][current_user_id]['computers_used'].append({
                        'computer_id': computer_id,
                        'computer_name': computer_data.get('computerName', 'Unknown'),
