...
class TestPackageService:
    ...
    def package_service(self, mock_firebase_client):
        ...
        with patch("services.package_service.DatabaseService.__init__", return_value=None):
    ...
    def test_get_all_packages_success(self, package_service):
        ...
        with patch.object(package_service, "get_all_documents", return_value={"success": True, "data": packages_data}):
            with patch.object(package_service, "log_operation"):
                with patch.object(package_service, "create_success_response", return_value={"success": True, "data": packages_data}):
    ...
    def test_get_all_packages_empty(self, package_service):
        ...
        with patch.object(package_service, "get_all_documents", return_value={"success": True, "data": []}):
            with patch.object(package_service, "log_operation"):
                with patch.object(package_service, "create_success_response", return_value={"success": True, "data": []}):
                    result = package_service.get_all_packages()
    ...
    def test_get_all_packages_failure(self, package_service):
        ...
        with patch.object(package_service, "get_all_documents", return_value={"success": False, "error": "Database error"}):
            with patch.object(package_service, "log_operation"):
                result = package_service.get_all_packages()
    ...
    def test_get_package_by_id_success(self, package_service):
        ...
        with patch.object(package_service, "get_document", return_value={"success": True, "data": package_data}):
            with patch.object(package_service, "log_operation"):
                with patch.object(package_service, "create_success_response") as mock_response:
                    mock_response.return_value = {"success": True, "data": {**package_data, "id": "pkg-123"}}
    ...
    def test_get_package_by_id_not_found(self, package_service):
        ...
        with patch.object(package_service, "get_document", return_value={"success": True, "data": None}):
            with patch.object(package_service, "log_operation"):
                with patch.object(package_service, "create_success_response", return_value={"success": True, "data": None}):
    ...
    def test_get_package_by_id_failure(self, package_service):
        ...
        with patch.object(package_service, "get_document", return_value={"success": False, "error": "Not found"}):
            with patch.object(package_service, "log_operation"):
                result = package_service.get_package_by_id("pkg-123")
